...
public class MyprofileStudentActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.myprofile_student);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		dialong = new AlertDialog.Builder(this);
		...
		_rpn_request_listener = new RequestNetwork.RequestListener() {
			...
			public void onErrorResponse(String _param1, String _param2) {
				...
				dialong.setTitle("⚠️ Connection Error ⚠️");
				dialong.setMessage("Internet is not Connected. please check connection and try again!!!");
				dialong.setPositiveButton("Try Again", new DialogInterface.OnClickListener() {
					@Override
